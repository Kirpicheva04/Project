...
class ActivatorInhibitorApp:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Анализ модели Майнхарда")
    ...
    def setup_gui(self):
        ...
        # Главный заголовок
        title_label = ttk.Label(self.root, text="АНАЛИЗ МОДЕЛИ МАЙНХАРДА",
                                style='Title.TLabel')
    ...
    def show_welcome_plot(self):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title('Анализ модели Майнхарда',
    ...
    def export_to_file(self):
        ...
        try:
            ...
            output.write("=" * 80 + "\n")
            output.write("АНАЛИЗ МОДЕЛИ МАЙНХАРДА\n")
            output.write("=" * 80 + "\n\n")
...
class NumericalTab:
    ...
    def show_welcome_plot(self):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title('Численное решение модели Майнхарда',
                     color='#0066cc', fontsize=14, pad=20)
